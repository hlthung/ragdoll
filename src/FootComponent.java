 ...
 */
public class FootComponent extends Sprite {
     ...
     * width and height
     */
    public FootComponent(int diameter) {
        super();
        this.initialize(diameter,diameter*2);
    }
    /**
     * Creates a rectangle based at the origin with the specified
     * width, height, and parent
     */
    public FootComponent(int width, int height, Sprite parentSprite) {
        super(parentSprite);
