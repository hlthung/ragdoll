 ...
 */
public class LegComponent extends Sprite {
     ...
     * width and height
     */
    public LegComponent(int width, int height) {
        super();
     ...
     */
    public LegComponent(int width, int height, Sprite parentSprite) {
        super(parentSprite);
        this.initialize(width, height);
    }
    ...
    protected void handleMouseDragEvent(MouseEvent e) throws NoninvertibleTransformException {    
        ...
        switch (interactionMode) {
            ...
            case DRAGGING:
                ...
                AffineTransform rotationInverse = null;
